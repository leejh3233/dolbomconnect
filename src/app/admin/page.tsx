    ...
    return (
        <div className="min-h-screen pb-20 font-gothic bg-[#f8fafc]">
                    ...
                    <div className="slide-up">
                        <div className="mb-6 flex justify-between items-center">
                            <button
                                ...
                                className="bg-slate-900 text-white px-5 py-2.5 rounded-2xl text-[12px] font-black shadow-lg shadow-slate-200 active:scale-95 transition-all flex items-center gap-2"
                            >
            ...
            {regModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in">
                    <div className="bg-white rounded-[2rem] p-8 max-w-sm w-full shadow-2xl animate-in zoom-in duration-200">
                        <h3 className="text-xl font-black mb-1">신규 인원 등록</h3>
                        <p className="text-slate-400 text-xs font-bold mb-8">새로운 파트너 또는 직원을 추가합니다.</p>

                        <div className="space-y-6 mb-8">
                            <div>
                                <label className="text-[10px] font-black text-slate-400 uppercase mb-2 block ml-1">이름</label>
                                <input
                                    type="text"
                                    value={regForm.name}
                            ...
                            <div>
                                ...
                                <div className="flex bg-slate-50 rounded-2xl p-1.5 border border-slate-100">
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-3 rounded-xl text-[11px] font-black transition-all ${regForm.type === '직원' ? 'bg-white shadow-md text-slate-900' : 'text-slate-400'}`}
                                    >
                                        직원
                                    </button>
                                </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-[2] bg-slate-900 text-white rounded-2xl font-black shadow-xl text-sm active:scale-95 transition-all disabled:opacity-50"
                            >
